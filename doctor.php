   ...
   <input type="checkbox" id="menu-toggle">
	...
	?>	
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                           <a href="update.php?booking_id=<?php echo $row["booking_id"];?>"><span class="las la-eye"></span></a> 
                                           <a href="deletebooking.php?booking_id=<?php echo $row['booking_id']?>"> <span class="fa-solid fa-trash"></span></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php	
